...
namespace web_lab1_fandom.Controllers
{
    public class CharactersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Gender,Burthyear,Photo,Status,Info")] Characters characters)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Gender,Burthyear,Photo,Status,Info")] Characters characters)
        {
            if (id != characters.ID)
            {
                return NotFound();
